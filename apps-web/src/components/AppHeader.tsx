...
function AppHeader({ onHome }: AppHeaderProps) {
  ...
  return <header className="app-header">
    ...
    <nav className="main-navigation" aria-label="Navigation principale"><a href="/">Accueil</a><a href="/community">Communauté</a><a href="/account">Mon espace</a><a href="/install">Installer</a></nav>
